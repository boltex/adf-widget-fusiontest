...
#### Build the adf-widget-fusiontest
...
```html
<script type="text/javascript" src="path/to/fusiontest.min.js"></script>
```

Define a dependency for the module:

```javascript
angular.module('sample', ['adf', 'adf.widget.fusiontest']);
```
